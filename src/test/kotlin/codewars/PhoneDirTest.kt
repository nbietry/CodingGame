...
class PhoneDirTest {
    ...
    fun test1() {
        ...
        testing(PhoneDir.phone(dr2, "8-421-674-8974"), "Phone => 8-421-674-8974, Name => Elizabeth Corber, Address => Via Papa Roma")
